...
class Rss(BaseController):
    ...
    def get(self):
        ...
        buff.append('        <link>http://ryanpoy.com</link>')
        buff.append('        <description><![CDATA[彭一的个人网站]]></description>')
        buff.append('        <atom:link href="http://ryanpoy.com/rss/" rel="self"/>')
        ...
        if articles:
            ...
            for a in articles:
                ...
                buff.append('    <link>http://ryanpoy.com/blogs/%s</link>' % a.id)
                buff.append('    <description><![CDATA[%s]]></description>' % a.limit_content(200))
                buff.append('    <guid>http://ryanpoy.com/blogs/%s</guid>' % a.id)
                buff.append('</item>')
        buff.append('''  </channel>''')
        buff.append('''</rss>''')
